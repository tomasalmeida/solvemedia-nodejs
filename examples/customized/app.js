...
app.get('/black/fr', function(req, res) {
    ...
    res.render('register', {
        ...
        locals: {
            name        : '',
            captcha     : solvemedia.toHTML(solvemedia.LANG.FR, solvemedia.THEME.BLACK), 
            errorMessage: ''
...
app.get('/black', function(req, res) {
    ...
    res.render('register', {
        ...
        locals: {
            name        : '',
            captcha     : solvemedia.toHTML(solvemedia.THEME.BLACK), 
            errorMessage: ''
...
app.get('/fr', function(req, res) {
    ...
    res.render('register', {
        ...
        locals: {
            name        : '',
            captcha     : solvemedia.toHTML(solvemedia.LANG.FR), 
            errorMessage: ''
